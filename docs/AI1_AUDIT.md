...
| | было | станет |
|---|---|---|
| перекладок в неделю | 22 | ~2 |
| оборот | 5.3 капитала ($530 526) | ~0.25 капитала |
| издержки/нед | $1 288 | ~$78 |
| издержки против заработка книги ($87/нед) | в 15 раз больше | в 1.1 раза меньше |
...
Прогноз проверяемый: через неделю сверить факт с ожиданием. Если перекладок окажется
**ноль** — ограничитель слишком туг, ослаблять до мягкой колонки (мин. 6 ч, бюджет 100 %),
которая всё ещё в 7 раз дешевле сегодняшнего.
...
**Следующий шаг:** через неделю сверить факт с прогнозом — ~2 перекладки и ~$78 издержек вместо 22 и $1 288
