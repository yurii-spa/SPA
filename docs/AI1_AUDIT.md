...
| **2.1** Стандарт уровней L0–L6 | `agent-ai1-21-standart-urovnei-dokazatelnosti` | 📋 `backlog` | ничем — **можно брать сейчас** |
| **2.2** APY Evidencer | `agent-ai1-22-apy-evidencer` | ⛔ `blocked` | задачей 2.1 |
| **2.3** Критерии тиров | `agent-ai1-23-kriterii-tirov` | 📋 `backlog` | ничем — **можно брать сейчас** |
| **2.4** Tier Validator | `agent-ai1-24-tier-validator` | ⛔ `blocked` | задачей 2.3 |
...
**Свободных фронта два: 2.1 и 2.3.** Оба — документы-стандарты, оба разблокированы,
и оба блокируют по одному агенту каждый. 2.3 срочнее: её отсутствие уже стоит
живого расхождения в книге (см. ниже).
