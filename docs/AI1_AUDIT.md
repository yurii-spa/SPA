...
| **2.4** Tier Validator | `agent-ai1-24-tier-validator` | 📋 `backlog` | **разблокирована 2026-08-29** |
...
**Свободный фронт остался один: 2.1** (стандарт уровней доказательности).
2.3 закрыта — `docs/tier_criteria.md` v0.1 + сторож `test_tier_declaration_agreement`,
и **2.4 (Tier Validator) этим разблокирована**.
