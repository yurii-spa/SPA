...
- **Honest edge (updated):** the hunt has now moved ONE candidate to ADVANCE-to-paper on evidence — **PT-sUSDe 11.2%**, whose solvency gate was underwritten + STRESS-PASSED (Oct-2025), funding-tail removed by the fixed wrapper. It is a **fundable THESIS**; its **scale is capacity-limited** (PT depth, SC-RDFC INSUFFICIENT_DATA-at-size). Still no *realized, fully-explained, fundable-at-SIZE* spread — the ceiling is thin-market capacity, not the risk logic. The desk's value remains the disciplined documented decision.
