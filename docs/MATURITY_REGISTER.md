...
|---|---|---|---|---|---|---|---|---|---|
| **Paper-трек и дневной цикл**<br/><sub>`01_project_overview.md` · `30_first_30_days_plan.md`</sub> | L5 | 73 | 29 | — | 4 | 161 | — | high | работает — не трогать |
...
| **Мониторинг, тревоги, здоровье флота**<br/><sub>`18_monitoring_and_alerting.md`</sub> | L5 | 74 | 88 | — | 22 | 49 | — | high | работает |
...
| **BTC capital cycle (лестница по фазам)**<br/><sub>`15_btc_cycle_framework.md` · `36_btc_capital_cycle_machine.md`</sub> | L2 | 0 | 0 | — | 0 | 2 | 36 | high | ПРОЕКТ ПОДГОТОВКИ: просадка −25% NAV не проходит под HARD_KILL −10%; бэктест сохранён, строить нельзя |
