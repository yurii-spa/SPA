...
_Обновлено: 2026-07-16 (автономный цикл #8: очередь пуста → hardening — починен реальный баг в живом intake: PARTIAL-сигнал §1a больше не теряется, +4 теста, ветка `env-setup-v3`)._
