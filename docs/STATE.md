...
_Обновлено: 2026-07-16 (автономный цикл #9: очередь пуста → hardening (диверсификация в адаптеры) — `ethena_susde._norm_apy` теперь fail-CLOSED на out-of-band APY (был молчаливый кламп до фейковых 50%, скрывал коллапс + глушил anomaly-флаг), +17 тестов (класс имел 0), ветка `env-setup-v3`)._
