...
**Remaining clean-but-large / skipped-with-reason:** Q4 coverage-floor RATCHET (roadmap Q4 says defer unless a retention regression surfaces) · Q2-14 KNOWN_SPENDERS — PARTIALLY SHIPPED (`60a240f`): added web-verified canonical singletons (Balancer V2 Vault `0xba12…2c8`, CoW GPv2VaultRelayer `0xc92e…0110`) to Base+L2 maps; further per-chain spenders still need real verified addresses (won't fabricate) + pair with the owner Etherscan unblock for real spender data · RWA-floor 3.18/3.4 reconcile (docs already ~3.4% consistent).
