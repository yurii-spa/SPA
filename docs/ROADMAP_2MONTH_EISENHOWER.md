...
**Remaining clean-but-large / skipped-with-reason:** Q3 bilingual checkup UI (L, chip away) · Q3 OG images (need design assets) · Q3 direct-nav-link (redundant with hero widget) · Q4 island-defer (documented-intent islands — left) · Q4 coverage floor (modest; fiddly ENS mock) · RWA-floor 3.18/3.4 reconcile (doc-busywork, docs already ~3.4% consistent).
