...
| ADR-061 | Гейт доказанности APY в money-path аллокаторе: литерал ≠ наблюдение (D1/D2), advisory не финансируется обоими путями (D3), GSM-гейт соблюдается (D4); fail-safe против обвала в кэш; каждый отказ назван. Пороги RiskPolicy не меняются | **Proposed (ждёт go на пуш)** | [ADR-061](ADR-061-apy-evidence-gate.md) |
