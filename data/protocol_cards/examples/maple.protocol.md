...
- **risk_score:** `TBD — Risk Scoring v2 run pending (docs/14). Qualitatively MODERATE (T2-ish): strong audits + overcollateralized + qualified custody + 3yr Syrup track, OFFSET by the inherent credit tail, the v1 $50M precedent, and the up-to-30-day withdrawal queue. A conservative sub-cap + underwriter DD advised.`
