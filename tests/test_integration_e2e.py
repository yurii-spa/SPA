...
class TestEngineRiskLimitsEnforced:
    ...
    Verify max_safe_position_size() clamps it AND tcheck_new_position() blocks it.
...
# =============================================================================
# Test 6: Replay synthetic fallback — ponil_history.json → valid metrics
# =============================================================================
