"""
Shared pytest fixtures for SPA test suite.
All fixtures use realistic but clearly synthetic data.
"""
import sys
import json
import pytest
...
# Make spa_core importable for all tests in this directory
_SPA_CORE = Path(__file__).parent.parent / "spa_core"
if str(_SPA_CORE) not in sys.path:
    sys.path.insert(0, str(_SPA_CORE))


# ── Pool / Protocol fixtures ──────────────────────────────────────────────
