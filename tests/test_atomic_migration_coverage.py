...
MIGRATED_MODULES = [
    ...
    ("spa_core.paper_trading.risk_contribution",       "_atomic_write_json"),
    ...
    ("spa_core.paper_trading.tail_risk",               "_atomic_write_json"),
    ("spa_core.paper_trading.cost_drag_analytics",     "_atomic_write_json"),
