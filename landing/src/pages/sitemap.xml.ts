...
export async function GET() {
  ...
  // BTC Signal Engine showcase (earn-defi D-46, SPA ADR-260): static HTML under public/btc-engine/,
  // generated by the separate earn-defi repo — not .astro pages, so the glob cannot see them.
  // Clean URLs: CF Pages canonicalises /btc-engine/x.html → /btc-engine/x (308).
  for (const p of ['/btc-engine/', '/btc-engine/signals', '/btc-engine/track', '/btc-engine/verify', '/btc-engine/runway']) {
    routes.add(p);
  }
