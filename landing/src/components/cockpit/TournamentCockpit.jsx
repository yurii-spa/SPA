...
function RulesPanel({ lang, metric }) {
  ...
  const rules = [
    ...
    { k: ru ? 'Частота ре-баланса' : 'Rebalance cadence', v: ru ? 'Ежедневный цикл (08:00 UTC): live APY/TVL → детерминированный RiskPolicy → ре-ранжирование. Турнир — 09:00 UTC.' : 'Daily cycle (08:00 UTC): live APY/TVL → deterministic RiskPolicy → re-rank. The tournament runs 09:00 UTC.' },
