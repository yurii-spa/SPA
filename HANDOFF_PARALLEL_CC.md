...
- Standing agent `com.spa.aggressive_lab` (daily, advisory, gate-passed). Owner flag `SPA_AGGRESSIVE_LAB_SELECT` (default OFF — does NOTHING to live allocation even when ON; promotion to real capital is owner+custody-gated).
