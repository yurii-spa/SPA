...
- `owner-decision-segodnyashnii-tsikl-treka-ne-zapuskalsya` — Сегодняшний цикл трека не запускался: Мак был выключен в 08:00 (этого варианта НЕ предлагает)
- `owner-decision-utochnenie-po-zametke-neprimenennyi-otve` — Уточнение по заметке: Неприменённый ответ владельца «1» — адресат не назван (этого варианта НЕ предлагает)
- `owner-decision-esche-devyatnadtsat-mest-gde-ne-izmerili` — Ещё девятнадцать мест, где «не измерили» читается как «продать всё» — чинить все или только одно? (предлагает этот вариант)
