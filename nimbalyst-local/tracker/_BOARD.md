...
>
> Собрана: 2026-08-28T20:14:34Z · сверка с карточками: `python3 scripts/build_tracker_board.py --check` (сторож `spa_core/tests/test_tracker_board_matches_cards.py`).
>
> Всего карточек: **744** · ждёт владельца: **1** · занято сессиями: **10**.

## 🔴 ЖДЁТ ВЛАДЕЛЬЦА (needs-owner)

- **Девять агентов не читает никто — какую партию отложить первой?** · _high_  ·  `own-36-partiya-agentov-v-karantin.md`
...
## 🧑‍⚖️ Owner Decisions (что нужно от владельца)  (180)
...
## 📥 Inbox (задания: Telegram / заметки / голос)  (366)
