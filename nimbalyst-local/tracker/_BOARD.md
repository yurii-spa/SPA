...
>
> Собрана: 2026-08-19T01:59:22Z · сверка с карточками: `python3 scripts/build_tracker_board.py --check` (сторож `spa_core/tests/test_tracker_board_matches_cards.py`).
>
> Всего карточек: **537** · ждёт владельца: **25** · занято сессиями: **3**.
...
- **Сбалансированный пакет не покупает ничего: в его коде нет самого шага выбора протоколов** · _high_  ·  `owner-decision-sbalansirovannyi-paket-ne-pokupaet-niche.md`
...
## 🧑‍⚖️ Owner Decisions (что нужно от владельца)  (142)
...
- Сбалансированный пакет не покупает ничего: в его коде нет самого шага выбора протоколов  ·  `owner-decision-sbalansirovannyi-paket-ne-pokupaet-niche.md` · 2026-08-18
...
## 📥 Inbox (задания: Telegram / заметки / голос)  (231)
...
- Семь скриптов остались без вызывающего, когда сканер перестал верить докстрингам — разбор поштучно  ·  `inbox-sem-skriptov-bez-vyzyvayuschego-razbor.md` · 2026-08-15
...
- Объявлен каноном, но не существовал никогда: у data/tier1_packages.json четыре разных статуса и ни одного производителя  ·  `inbox-obyavlen-kanonom-no-ne-suschestvoval-nikogda.md` · 2026-08-18
...
- Потолок «T2 суммарно ≤ 50 %» не перепроверяется на уровне портфеля — 60 % в T2 проходит с нулём нарушений  ·  `agent-t2-total-cap-ne-proveryaetsya-na-portfele.md` · 2026-08-18
