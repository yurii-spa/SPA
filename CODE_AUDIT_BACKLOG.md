...
- `test_strategy_selector` (5): фикстуры с `tvl_usd: 0.0` → TVL-floor ($5M)
  ...
  Один — `weights sum 1.000009 > 1+1e-9`: **float-overshoot аллокатора** (связан
  с H2 исходного аудита — веса могут марг. превышать сумму/cap из-за float).
