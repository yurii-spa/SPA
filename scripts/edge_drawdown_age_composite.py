#!/usr/bin/env python3
"""
scripts/edge_drawdown_age_composite.py — Idea #25: Drawdown-Age Composite Risk Signal (DACRS)

NOVEL EDGE IDEA #25 (docs/DYNAMIC_LEVERAGE_GUARDIAN.md registry):
...
THE ECONOMIC HYPOTHESIS
  ...
  • DACRS #25:  fires when EITHER (a) depth is large OR (b) age is long → catches both
...
def main() -> None:
    print("=" * 78)
    print("IDEA #25: Drawdown-Age Composite Risk Signal (DACRS)")
    ...
    print(f"\n--- DACRS #25 sweep (top 10 by Calmar) ---")
    ...
    if best:
        print(f"  {'DACRS #25 (best)':20s}  {_f(best['apy']):>10}  {_f(best['dd']):>12}  {_f(best['calmar']):>12}  {_f(best['oos_calmar']):>10}")
