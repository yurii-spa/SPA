#!/usr/bin/env bash
# scripts/push_v879.sh
# Sprint v8.79 — MP-1233 DeFiProtocolVaultPerformanceFeeGrossOfL1DataFeeBaseGapAnalyzer
# Run on Mac: bash scripts/push_v879.sh
...
# ── files changed in v8.79 ───────────────────────────────────────────────────
FILES=(
  "spa_core/analytics/defi_protocol_vault_performance_fee_gross_of_l1_data_fee_base_gap_analyzer.py"
  "spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_l1_data_fee_base_gap_analyzer.py"
...
MSG="v8.79 MP-1233 DeFiProtocolVaultPerformanceFeeGrossOfL1DataFeeBaseGapAnalyzer (97 tests, yield_quality Tier-B) — perf-fee gross-of-L1-data-fee base gap (L2 rollup calldata/DA posting fee); B=488 total=680 done_count=926"
