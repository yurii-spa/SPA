#!/usr/bin/env bash
# scripts/push_v877.sh
# Sprint v8.77 — MP-1231 DeFiProtocolVaultPerformanceFeeGrossOfFlashLoanFeeBaseGapAnalyzer
# Run on Mac: bash scripts/push_v877.sh
...
# ── files changed in v8.77 ───────────────────────────────────────────────────
FILES=(
  "spa_core/analytics/defi_protocol_vault_performance_fee_gross_of_flash_loan_fee_base_gap_analyzer.py"
  "spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_flash_loan_fee_base_gap_analyzer.py"
...
MSG="v8.77 MP-1231 DeFiProtocolVaultPerformanceFeeGrossOfFlashLoanFeeBaseGapAnalyzer (97 tests, yield_quality Tier-B) — perf-fee gross-of flash-loan-fee base gap; B=486 total=678 done_count=924"
