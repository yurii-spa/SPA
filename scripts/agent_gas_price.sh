...
# bash wrapper runs it correctly. Log: /tmp/spa_gas_price.log
...
exec /bin/bash /Users/yuriikulieshov/Documents/SPA_Claude/scripts/agent_template.sh gas_price spa_core.monitoring.gas_price_agent --run
