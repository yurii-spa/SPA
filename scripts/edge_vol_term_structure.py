#!/usr/bin/env python3
"""
scripts/edge_vol_term_structure.py — Idea #24: Volatility Term Structure Trigger (VTST)

NOVEL EDGE IDEA #24 (docs/DYNAMIC_LEVERAGE_GUARDIAN.md registry):
...
def main() -> None:
    print("=" * 72)
    print("VTST #24 — Volatility Term Structure Trigger Backtest")
    ...
    if best_result:
        ...
        print(f"  {'VTST #24 (best config)':35s} {best_result['apy_pct']:>8.3f} "
    ...
    print("  See registry entry #24 for caveats.")
