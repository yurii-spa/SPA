...
|---------|-------|----------|
| Daily DD | ≥ 1% | Warning + алерт Owner |
| Weekly DD | ≥ 2% | Critical + safe-mode |
| Monthly DD | ≥ 3% | Critical + global stop |
| Annual DD (rolling 12m) | > 5% | mandatory review Risk Policy через ADR |
