...
|----|---------|--------|--------|----------------------|
| 00 | Context | v0.4.5 | Draft | 00_Context_v0.4.5_DRAFT.md |
| 02 | Mode Policy | v0.4.5 | Draft | Mode_Policy_v0.4.5_DRAFT.md |
| 03 | Risk Policy | v0.4.5 | Draft | Risk_Policy_v0.4.5_DRAFT.md |
| 04 | Whitelist Policy | v0.4.5 | Draft | 04_Whitelist_Policy_v0.4.5_DRAFT.md |
| 13 | Operations Runbook | v0.4.5 | Draft | 13_Operations_Runbook_v0.4.5_DRAFT.md |
| 14 | Incident Response | v0.4.5 | Draft | 14_Incident_Response_v0.4.5_DRAFT.md |
| 15 | Monitoring & Alerts | v0.4.5 | Draft | 15_Monitoring_and_Alerts_v0.4.5_DRAFT.md |
| 16 | Data & Signals | v0.4.5 | Draft | 16_Data_and_Signals_v0.4.5_DRAFT.md |
| 18 | Agent Architecture | v0.4.5 | Draft | 18_Agent_Architecture_v0.4.5_DRAFT.md |
...
| ID | Документ | Версия | Статус | Актуальное имя файла |
|----|---------|--------|--------|----------------------|
| 05 | Execution Cost Model | v0.4.5 | Draft | Execution_Cost_Model_v0.4.5_DRAFT.md |
| 06 | Accounting & PnL Attribution | v0.4.5 | Draft | Accounting_and_PnL_Attribution_Model_v0.4.5_DRAFT.md |
| 07 | Weekly Reporting Template | v0.4.5 | Draft | Reporting_Weekly_Template_v0.4.5_DRAFT.md |
| 08 | Paper Trading & Simulation | v0.4.5 | Draft | Paper_Trading_and_Simulation_Plan_v0.4.5_DRAFT.md |
...
| ID | Документ | Версия | Статус | Актуальное имя файла |
|----|---------|--------|--------|----------------------|
| 09 | Strategy Passport Template | v0.4.5 | Draft | Strategy_Passport_Template_v0.4.5_DRAFT.md |
| 10 | Stable Lending Core Strategy | v0.4.5 | Draft | Strategy_Passport_Stable_Lending_Core_v0.4.5_DRAFT.md |
...
| ADR-2026-006 | Расширенный whitelist v0.4 | Accepted 2026-05-01 |
