...
#: Проверено чтением модуля и его пакета 28.08: пишет только в /tmp (пульс, кулдауны дедупа) — это эфемерное состояние процесса, а не артефакт флота; результат уезжает ВЛАДЕЛЬЦУ тревогой.
