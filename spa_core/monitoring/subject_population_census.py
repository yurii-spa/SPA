...
#: `.astro` добавлен 15.09 (ADR-395). Дорога A нашла сайты в
#: `test_astro_attribute_interpolation.py`, а дорога B их не видела — её отбор
#: файлов требует упоминания расширения ИСХОДНИКА, и `.astro` в списке не было.
#: Это и есть «B сузилась»: в репозитории появился сторож, читающий исходник
#: страницы, а перепись о нём не знала. Расширение — исходник соседа в том же
#: смысле, что `.py`: его ЧИТАЮТ как текст кода, а не как данные (потому `.json`
