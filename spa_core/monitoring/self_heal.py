...
#   Порог 600 с = 2× BEACON_MAX_AGE_S сторожа `telegram_health` (300 с — «крутится
#   ли цикл»): короткая пауза сети ещё не «мёртв» — kickstart только при двукратном.
#   Порог КНОПОК (`alert_actions.BEACON_MAX_AGE_S`) с ADR-399 — другой вопрос и часы,
#   а не минуты; равнять эти два числа больше нельзя.
