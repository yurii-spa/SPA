...
class CompoundV3Adapter:
    ...
    def _send_raw_tx(self, signed_hex: str, *, proposed_gas_gwei: float | None = None) -> str:
        ...
        """
        assert_live_armed("compound_v3._send_raw_tx")
    ...
    def get_supply_apy(self, asset: str) -> float:
        ...
        try:
            ...
            if not util_body:
                raise ValidationError("getUtilization", util_hex, "empty response")
            ...
            if not rate_body:
                raise ValidationError("getSupplyRate", rate_hex, "empty response")
