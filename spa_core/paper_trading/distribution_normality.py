...
CLI::
    ...
    python -m spa_core.paper_trading.distribution_normality
    python -m spa_core.paper_trading.distribution_normality --history data/pnl_history.json \\
...
log = logging.getLogger("spa.paper_trading.distribution_normality")
...
def generate_normality_report(
    ...
    if output_path is not None:
        ...
        try:
            ...
            tmp = out.with_name(f".distribution_normality_{os.getpid()}.tmp")
