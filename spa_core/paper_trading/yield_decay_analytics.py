...
CLI::
    ...
    python3 -m spa_core.paper_trading.yield_decay_analytics --check    # compute+print, no write (default)
    python3 -m spa_core.paper_trading.yield_decay_analytics --run      # + atomic write
    python3 -m spa_core.paper_trading.yield_decay_analytics --run --data-dir <dir>
...
log = logging.getLogger("spa.paper_trading.yield_decay_analytics")
...
def write_status(
    ...
    fd, tmp_path = tempfile.mkstemp(dir=data_dir, prefix=".tmp_yield_decay_")
    try:
