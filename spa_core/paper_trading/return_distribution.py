...
CLI::
    ...
    python -m spa_core.paper_trading.return_distribution
    python -m spa_core.paper_trading.return_distribution --history data/pnl_history.json \\
...
log = logging.getLogger("spa.paper_trading.return_distribution")
