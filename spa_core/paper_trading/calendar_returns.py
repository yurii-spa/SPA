...
CLI::
    ...
    python -m spa_core.paper_trading.calendar_returns
    python -m spa_core.paper_trading.calendar_returns --history data/pnl_history.json \\
...
log = logging.getLogger("spa.paper_trading.calendar_returns")
