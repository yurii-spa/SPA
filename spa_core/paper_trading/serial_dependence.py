...
CLI::
    ...
    python -m spa_core.paper_trading.serial_dependence
    python -m spa_core.paper_trading.serial_dependence --history data/pnl_history.json \\
...
log = logging.getLogger("spa.paper_trading.serial_dependence")
