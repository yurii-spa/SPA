...
CLI::
    ...
    python3 -m spa_core.paper_trading.bias_ratio --check   # compute+print, no write (default)
    python3 -m spa_core.paper_trading.bias_ratio --run     # + atomic write
    python3 -m spa_core.paper_trading.bias_ratio --run --data-dir <dir>
...
log = logging.getLogger("spa.paper_trading.bias_ratio")
...
def write_status(
    ...
    fd, tmp_path = tempfile.mkstemp(dir=data_dir, prefix=".tmp_bias_ratio_")
    try:
