...
CLI::
    ...
    python -m spa_core.paper_trading.advanced_ratios
    python -m spa_core.paper_trading.advanced_ratios --history data/pnl_history.json \\
...
log = logging.getLogger("spa.paper_trading.advanced_ratios")
...
def generate_advanced_ratios_report(
    ...
    if output_path is not None:
        ...
        try:
            ...
            tmp = out.with_name(f".advanced_ratios_{os.getpid()}.tmp")
