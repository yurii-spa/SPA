...
CLI::
    ...
    python -m spa_core.analytics_lab.regime_segmentation
    python -m spa_core.analytics_lab.regime_segmentation --history data/pnl_history.json \\
...
log = logging.getLogger("spa.analytics_lab.regime_segmentation")
