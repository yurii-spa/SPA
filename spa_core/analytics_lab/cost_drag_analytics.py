...
CLI (offline, exit 0 always, no tracebacks; junk args → clear ERROR on stderr)::
    ...
    python3 -m spa_core.analytics_lab.cost_drag_analytics --check   # compute+print, no write (default)
    python3 -m spa_core.analytics_lab.cost_drag_analytics --run     # + atomic write
    python3 -m spa_core.analytics_lab.cost_drag_analytics --run --data-dir <dir>
...
log = logging.getLogger("spa.analytics_lab.cost_drag_analytics")
...
def _build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python3 -m spa_core.analytics_lab.cost_drag_analytics",
        description=(
