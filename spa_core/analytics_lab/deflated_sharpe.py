...
CLI::
    ...
    python3 -m spa_core.analytics_lab.deflated_sharpe --check    # compute+print, no write (default)
    python3 -m spa_core.analytics_lab.deflated_sharpe --run      # + atomic write
    python3 -m spa_core.analytics_lab.deflated_sharpe --run --data-dir <dir>
...
log = logging.getLogger("spa.analytics_lab.deflated_sharpe")
