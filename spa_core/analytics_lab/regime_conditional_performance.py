...
CLI (offline, exit 0 always, no tracebacks; junk args → ERROR on stderr)::
    ...
    python3 -m spa_core.analytics_lab.regime_conditional_performance --check  # compute+print, no write (default)
    python3 -m spa_core.analytics_lab.regime_conditional_performance --run    # + atomic write
    python3 -m spa_core.analytics_lab.regime_conditional_performance --run --data-dir <dir>
...
log = logging.getLogger("spa.analytics_lab.regime_conditional_performance")
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python3 -m spa_core.analytics_lab.regime_conditional_performance",
        description=(
