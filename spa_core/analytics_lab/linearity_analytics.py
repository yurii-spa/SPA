...
CLI::
    ...
    python -m spa_core.analytics_lab.linearity_analytics
    python -m spa_core.analytics_lab.linearity_analytics --history data/pnl_history.json \\
...
log = logging.getLogger("spa.analytics_lab.linearity_analytics")
