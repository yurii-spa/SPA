...
CLI::
    ...
    python3 -m spa_core.analytics_lab.k_ratio --check   # compute+print, no write (default)
    python3 -m spa_core.analytics_lab.k_ratio --run     # + atomic write
    python3 -m spa_core.analytics_lab.k_ratio --run --data-dir <dir>
...
log = logging.getLogger("spa.analytics_lab.k_ratio")
