...
CLI::
    ...
    python -m spa_core.analytics_lab.return_predictability
    python -m spa_core.analytics_lab.return_predictability --history data/pnl_history.json \\
...
log = logging.getLogger("spa.analytics_lab.return_predictability")
