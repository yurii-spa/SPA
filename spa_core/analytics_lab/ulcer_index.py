...
CLI::
    ...
    python3 -m spa_core.analytics_lab.ulcer_index --check   # compute+print, no write (default)
    python3 -m spa_core.analytics_lab.ulcer_index --run     # + atomic write
    python3 -m spa_core.analytics_lab.ulcer_index --run --data-dir <dir>
...
log = logging.getLogger("spa.analytics_lab.ulcer_index")
