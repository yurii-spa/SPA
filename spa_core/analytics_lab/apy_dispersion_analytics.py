...
CLI::
    ...
    python3 -m spa_core.analytics_lab.apy_dispersion_analytics --check    # compute+print, no write (default)
    python3 -m spa_core.analytics_lab.apy_dispersion_analytics --run      # + atomic write
    python3 -m spa_core.analytics_lab.apy_dispersion_analytics --run --data-dir <dir>
...
log = logging.getLogger("spa.analytics_lab.apy_dispersion_analytics")
