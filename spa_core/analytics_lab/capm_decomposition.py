...
CLI::
    ...
    python3 -m spa_core.analytics_lab.capm_decomposition --check   # compute+print, no write (default)
    python3 -m spa_core.analytics_lab.capm_decomposition --run     # + atomic write
    python3 -m spa_core.analytics_lab.capm_decomposition --run --data-dir <dir>
...
log = logging.getLogger("spa.analytics_lab.capm_decomposition")
