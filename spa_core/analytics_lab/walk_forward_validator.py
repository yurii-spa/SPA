...
CLI (offline, exit 0 always)::
    ...
    python3 -m spa_core.analytics_lab.walk_forward_validator --check
    python3 -m spa_core.analytics_lab.walk_forward_validator --check --data-dir <dir>
...
log = logging.getLogger("spa.analytics_lab.walk_forward_validator")
