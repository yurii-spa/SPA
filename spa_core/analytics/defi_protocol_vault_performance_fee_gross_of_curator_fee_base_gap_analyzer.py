...
Thin wrapper: the gross-of-curator-fee performance-fee base-gap engine lives in
...
per module). This module supplies the curator-fee-specific vocabulary (input/output
...
``spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_curator_fee_base_gap_analyzer.py`` is unmodified and remains the equivalence
proof.
...
LOG_PATH = os.path.join(
    ...
    "data", "vault_performance_fee_gross_of_curator_fee_base_gap_log.json"
)
...
_api = build_module_api(
    class_name="DeFiProtocolVaultPerformanceFeeGrossOfCuratorFeeBaseGapAnalyzer",
    log_path=LOG_PATH,
    high_threshold=HIGH_CURATOR_FEE_PCT,
    keys={
        "gross": "gross_yield_pct",
        "net": "net_of_curator_fee_yield_pct",
        "consumed": "curator_fee_consumed_yield_pct",
        "gap": "fee_on_curator_fee_gap_pct",
        "fraction": "fee_on_curator_fee_fraction",
        "rate": "curator_fee_rate_pct",
    },
    labels={
        "clean": "CLEAN_NET_OF_CURATOR_FEE_BASE",
        "mild": "MILD_FEE_ON_CURATOR_FEE_GAP",
        "moderate": "MODERATE_FEE_ON_CURATOR_FEE_GAP",
        "severe": "SEVERE_FEE_ON_CURATOR_FEE_GAP",
        "trust": "TRUST_FEE_STRUCTURE",
        "minor": "MINOR_FEE_ON_CURATOR_FEE",
        "demand": "DEMAND_NET_OF_CURATOR_FEE_BASE",
        "avoid": "AVOID_FEE_ON_CURATOR_FEE",
        "high_flag": "HIGH_CURATOR_FEE",
        "fee_on_flag": "FEE_ON_CURATOR_FEE",
        "full_fee_on_flag": "FULL_FEE_ON_CURATOR_FEE",
        "agg_worst": "worst_curator_fee_gap_vault",
    },
)

DeFiProtocolVaultPerformanceFeeGrossOfCuratorFeeBaseGapAnalyzer = _api["analyzer_cls"]
