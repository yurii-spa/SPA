...
Thin wrapper: the gross-of-keeper-fee performance-fee base-gap engine lives in
...
per module). This module supplies the keeper-fee-specific vocabulary (input/output
...
``spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_keeper_fee_base_gap_analyzer.py`` is unmodified and remains the equivalence
proof.
...
LOG_PATH = os.path.join(
    ...
    "data", "vault_performance_fee_gross_of_keeper_fee_base_gap_log.json"
)

# High-keeper-fee flag threshold on keeper_fee_rate_pct.
HIGH_KEEPER_FEE_PCT = 0.3

_api = build_module_api(
    class_name="DeFiProtocolVaultPerformanceFeeGrossOfKeeperFeeBaseGapAnalyzer",
    log_path=LOG_PATH,
    high_threshold=HIGH_KEEPER_FEE_PCT,
    keys={
        "gross": "gross_yield_pct",
        "net": "net_of_keeper_fee_yield_pct",
        "consumed": "keeper_fee_consumed_yield_pct",
        "gap": "keeper_fee_gap_pct",
        "fraction": "fee_on_keeper_fee_fraction",
        "rate": "keeper_fee_rate_pct",
    },
    labels={
        "clean": "CLEAN_NET_OF_KEEPER_FEE_BASE",
        "mild": "MILD_FEE_ON_KEEPER_FEE_GAP",
        "moderate": "MODERATE_FEE_ON_KEEPER_FEE_GAP",
        "severe": "SEVERE_FEE_ON_KEEPER_FEE_GAP",
        "trust": "TRUST_FEE_STRUCTURE",
        "minor": "MINOR_FEE_ON_KEEPER_FEE",
        "demand": "DEMAND_NET_OF_KEEPER_FEE_BASE",
        "avoid": "AVOID_FEE_ON_KEEPER_FEE",
        "high_flag": "HIGH_KEEPER_FEE",
        "fee_on_flag": "FEE_ON_KEEPER_FEE",
        "full_fee_on_flag": "FULL_FEE_ON_KEEPER_FEE",
        "agg_worst": "worst_keeper_fee_gap_vault",
    },
)

DeFiProtocolVaultPerformanceFeeGrossOfKeeperFeeBaseGapAnalyzer = _api["analyzer_cls"]
