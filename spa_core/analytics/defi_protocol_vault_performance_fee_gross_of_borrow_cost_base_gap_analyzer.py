...
Thin wrapper: the gross-of-borrow-cost performance-fee base-gap engine lives in
...
per module). This module supplies the borrow-cost-specific vocabulary (input/output
...
``spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_borrow_cost_base_gap_analyzer.py`` is unmodified and remains the equivalence
proof.
...
_api = build_module_api(
    class_name="DeFiProtocolVaultPerformanceFeeGrossOfBorrowCostBaseGapAnalyzer",
    log_path=LOG_PATH,
    high_threshold=HIGH_BORROW_COST_PCT,
    keys={
        "gross": "gross_yield_pct",
        "net": "net_of_borrow_cost_yield_pct",
        "consumed": "borrow_consumed_yield_pct",
        "gap": "fee_on_borrow_cost_gap_pct",
        "fraction": "fee_on_borrow_cost_fraction",
        "rate": "borrow_cost_rate_pct",
    },
    labels={
        "clean": "CLEAN_NET_OF_BORROW_BASE",
        "mild": "MILD_FEE_ON_BORROW_GAP",
        "moderate": "MODERATE_FEE_ON_BORROW_GAP",
        "severe": "SEVERE_FEE_ON_BORROW_GAP",
        "trust": "TRUST_FEE_STRUCTURE",
        "minor": "MINOR_FEE_ON_BORROW",
        "demand": "DEMAND_NET_OF_BORROW_BASE",
        "avoid": "AVOID_FEE_ON_BORROW",
        "high_flag": "HIGH_BORROW_COST",
        "fee_on_flag": "FEE_ON_BORROW_COST",
        "full_fee_on_flag": "FULL_FEE_ON_BORROW",
        "agg_worst": "worst_borrow_gap_vault",
    },
)

DeFiProtocolVaultPerformanceFeeGrossOfBorrowCostBaseGapAnalyzer = _api["analyzer_cls"]
