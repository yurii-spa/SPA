...
Thin wrapper: the gross-of-swap-fee performance-fee base-gap engine lives in
...
per module). This module supplies the swap-fee-specific vocabulary (input/output
...
``spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_swap_fee_base_gap_analyzer.py`` is unmodified and remains the equivalence
proof.
...
_api = build_module_api(
    class_name="DeFiProtocolVaultPerformanceFeeGrossOfSwapFeeBaseGapAnalyzer",
    log_path=LOG_PATH,
    high_threshold=HIGH_SWAP_FEE_PCT,
    keys={
        "gross": "gross_yield_pct",
        "net": "net_of_swap_fee_yield_pct",
        "consumed": "swap_fee_consumed_yield_pct",
        "gap": "fee_on_swap_fee_gap_pct",
        "fraction": "fee_on_swap_fee_fraction",
        "rate": "swap_fee_rate_pct",
    },
    labels={
        "clean": "CLEAN_NET_OF_SWAP_FEE_BASE",
        "mild": "MILD_FEE_ON_SWAP_FEE_GAP",
        "moderate": "MODERATE_FEE_ON_SWAP_FEE_GAP",
        "severe": "SEVERE_FEE_ON_SWAP_FEE_GAP",
        "trust": "TRUST_FEE_STRUCTURE",
        "minor": "MINOR_FEE_ON_SWAP_FEE",
        "demand": "DEMAND_NET_OF_SWAP_FEE_BASE",
        "avoid": "AVOID_FEE_ON_SWAP_FEE",
        "high_flag": "HIGH_SWAP_FEE",
        "fee_on_flag": "FEE_ON_SWAP_FEE",
        "full_fee_on_flag": "FULL_FEE_ON_SWAP_FEE",
        "agg_worst": "worst_swap_fee_gap_vault",
    },
)

DeFiProtocolVaultPerformanceFeeGrossOfSwapFeeBaseGapAnalyzer = _api["analyzer_cls"]
