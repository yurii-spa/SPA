...
Thin wrapper: the gross-of-bridge-fee performance-fee base-gap engine lives in
...
per module). This module supplies the bridge-fee-specific vocabulary (input/output
...
``spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_bridge_fee_base_gap_analyzer.py`` is unmodified and remains the equivalence
proof.
...
_api = build_module_api(
    class_name="DeFiProtocolVaultPerformanceFeeGrossOfBridgeFeeBaseGapAnalyzer",
    log_path=LOG_PATH,
    high_threshold=HIGH_BRIDGE_FEE_PCT,
    keys={
        "gross": "gross_yield_pct",
        "net": "net_of_bridge_fee_yield_pct",
        "consumed": "bridge_fee_consumed_yield_pct",
        "gap": "fee_on_bridge_fee_gap_pct",
        "fraction": "fee_on_bridge_fee_fraction",
        "rate": "bridge_fee_cost_pct",
    },
    labels={
        "clean": "CLEAN_NET_OF_BRIDGE_FEE_BASE",
        "mild": "MILD_FEE_ON_BRIDGE_FEE_GAP",
        "moderate": "MODERATE_FEE_ON_BRIDGE_FEE_GAP",
        "severe": "SEVERE_FEE_ON_BRIDGE_FEE_GAP",
        "trust": "TRUST_FEE_STRUCTURE",
        "minor": "MINOR_FEE_ON_BRIDGE_FEE",
        "demand": "DEMAND_NET_OF_BRIDGE_FEE_BASE",
        "avoid": "AVOID_FEE_ON_BRIDGE_FEE",
        "high_flag": "HIGH_BRIDGE_FEE",
        "fee_on_flag": "FEE_ON_BRIDGE_FEE",
        "full_fee_on_flag": "FULL_FEE_ON_BRIDGE_FEE",
        "agg_worst": "worst_bridge_fee_gap_vault",
    },
)

DeFiProtocolVaultPerformanceFeeGrossOfBridgeFeeBaseGapAnalyzer = _api["analyzer_cls"]
