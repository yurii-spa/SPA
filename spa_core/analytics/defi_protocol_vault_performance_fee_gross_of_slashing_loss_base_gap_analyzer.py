...
Thin wrapper: the gross-of-slashing-loss performance-fee base-gap engine lives in
...
per module). This module supplies the slashing-loss-specific vocabulary (input/output
...
``spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_slashing_loss_base_gap_analyzer.py`` is unmodified and remains the equivalence
proof.
...
_api = build_module_api(
    class_name="DeFiProtocolVaultPerformanceFeeGrossOfSlashingLossBaseGapAnalyzer",
    log_path=LOG_PATH,
    high_threshold=HIGH_SLASHING_LOSS_PCT,
    keys={
        "gross": "gross_yield_pct",
        "net": "net_of_slashing_loss_yield_pct",
        "consumed": "slashing_loss_consumed_yield_pct",
        "gap": "fee_on_slashing_loss_gap_pct",
        "fraction": "fee_on_slashing_loss_fraction",
        "rate": "slashing_loss_cost_pct",
    },
    labels={
        "clean": "CLEAN_NET_OF_SLASHING_LOSS_BASE",
        "mild": "MILD_FEE_ON_SLASHING_LOSS_GAP",
        "moderate": "MODERATE_FEE_ON_SLASHING_LOSS_GAP",
        "severe": "SEVERE_FEE_ON_SLASHING_LOSS_GAP",
        "trust": "TRUST_FEE_STRUCTURE",
        "minor": "MINOR_FEE_ON_SLASHING_LOSS",
        "demand": "DEMAND_NET_OF_SLASHING_LOSS_BASE",
        "avoid": "AVOID_FEE_ON_SLASHING_LOSS",
        "high_flag": "HIGH_SLASHING_LOSS",
        "fee_on_flag": "FEE_ON_SLASHING_LOSS",
        "full_fee_on_flag": "FULL_FEE_ON_SLASHING_LOSS",
        "agg_worst": "worst_slashing_loss_gap_vault",
    },
)

DeFiProtocolVaultPerformanceFeeGrossOfSlashingLossBaseGapAnalyzer = _api["analyzer_cls"]
