...
Thin wrapper: the gross-of-reserve-contribution performance-fee base-gap engine lives in
...
per module). This module supplies the reserve-contribution-specific vocabulary (input/output
...
``spa_core/tests/test_defi_protocol_vault_performance_fee_gross_of_reserve_contribution_base_gap_analyzer.py`` is unmodified and remains the equivalence
proof.
...
# High-reserve-contribution flag threshold on reserve_contribution_rate_pct.
HIGH_RESERVE_DIVERSION_PCT = 20.0

_api = build_module_api(
    class_name="DeFiProtocolVaultPerformanceFeeGrossOfReserveContributionBaseGapAnalyzer",
    log_path=LOG_PATH,
    high_threshold=HIGH_RESERVE_DIVERSION_PCT,
    keys={
        "gross": "gross_yield_pct",
        "net": "net_of_reserve_yield_pct",
        "consumed": "reserve_consumed_yield_pct",
        "gap": "fee_on_reserve_gap_pct",
        "fraction": "fee_on_reserve_fraction",
        "rate": "reserve_contribution_rate_pct",
    },
    labels={
        "clean": "CLEAN_NET_OF_RESERVE_BASE",
        "mild": "MILD_FEE_ON_RESERVE_GAP",
        "moderate": "MODERATE_FEE_ON_RESERVE_GAP",
        "severe": "SEVERE_FEE_ON_RESERVE_GAP",
        "trust": "TRUST_FEE_STRUCTURE",
        "minor": "MINOR_FEE_ON_RESERVE",
        "demand": "DEMAND_NET_OF_RESERVE_BASE",
        "avoid": "AVOID_FEE_ON_RESERVE",
        "high_flag": "HIGH_RESERVE_DIVERSION",
        "fee_on_flag": "FEE_ON_RESERVE_CONTRIBUTION",
        "full_fee_on_flag": "FULL_FEE_ON_RESERVE",
        "agg_worst": "worst_reserve_gap_vault",
    },
)

DeFiProtocolVaultPerformanceFeeGrossOfReserveContributionBaseGapAnalyzer = _api["analyzer_cls"]
