"""Maple Finance adapter (T2 tier) — read-only, live DeFiLlama feed only.
...
class MapleAdapter(BaseAdapter):
    ...
    # The Maple lending pool on DeFiLlama is symbol "USDC" (the ~$3B pool);
    # verified against the live yields API (SPA-V398).
