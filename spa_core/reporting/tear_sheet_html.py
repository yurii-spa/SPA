...
Split out of :mod:`spa_core.reporting.tear_sheet` (P3-15 dedup) — the public
monthly markdown tear-sheet stays there and re-exports this class for backward
compatibility, so existing callers (``from spa_core.reporting.tear_sheet import
TearSheetGenerator``) keep working unchanged.
