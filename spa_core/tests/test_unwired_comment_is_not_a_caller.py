...
нет, класс схлопнут в один дневной дайджест). Слепота к ДОКСТРИНГАМ стоит ещё
8 скриптов — она названа в `code_without_comments` и вынесена карточкой, здесь
закреплена тестом `..._KNOWN_GAP` в явном виде.
