...
Note: requires fastapi. In stdlib-only envs pytest skips this entire directory.
"""
...
# ---------------------------------------------------------------------------
# When fastapi is absent, skip every test in this directory immediately.
# ---------------------------------------------------------------------------
if not _FASTAPI_OK:
    @pytest.fixture(autouse=True)
    def _skip_no_fastapi():
        pytest.skip("fastapi not installed — Family Fund API tests skipped")
