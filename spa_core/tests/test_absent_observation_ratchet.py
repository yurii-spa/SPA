...
# 11.09 (ADR-344): потолки ОПУЩЕНЫ 192→148 и 60→52 — все 185 мест, появившихся
# за 16 суток без инварианта #17 в конституции, разобраны поимённо, и база
# пересобрана вниз. Поднимать их нельзя; опускать — можно и нужно.
CEILINGS = {ao.SIGNAL_OR: 148, ao.SIGNAL_EXCEPT: 52}
...
COORDINATE_CEILINGS = {ao.SIGNAL_OR: 143, ao.SIGNAL_EXCEPT: 52}
