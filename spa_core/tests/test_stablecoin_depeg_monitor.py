"""
Tests for MP-744: StablecoinDepegMonitor
...
from spa_core.analytics.stablecoin_depeg_monitor import (  # noqa: E402
    MAX_ENTRIES,
    SEVERITY_MINOR_BPS,
...
class TestAnalyzeGuards(unittest.TestCase):
    ...
    def test_returns_report_type(self):
        self.assertIsInstance(self.m.analyze([1.0]), DepegReport)
