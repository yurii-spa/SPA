...
#: `data/telegram_last_update_id.json` у `telegram_watcher`. Разбор, который
#: видит два из трёх, читается как «всё чисто» — тот же класс, что и сторож,
#: честно отвечающий не на тот вопрос.
