...
# FROZEN-DATE-OK: historical-incident — наблюдённые значения цикла #501 (06.09), сравниваются
# на равенство хешей; now= у dr.run лишь штампует generated_at и свежести не судит.
