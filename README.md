...
Версия: v12.87 | Язык: Python 3 (stdlib-only runtime) | Статус: Paper Trading — реальный трек с honest anchor **2026-06-22** (committed-snapshot **14/30** evidenced честных дней, GoLive 27/29; живой прод на 2026-08-24 — **62/30** и GoLive **29/29**, коммитнутый `data/golive_status.json` заморожен и отстаёт на 49 дней; target ~2026-07-21)
