...
Версия: v1.0.0 | Язык: Python 3.11+ | Статус: Paper Trading (Week 0 baseline: 2026-05-02)

---

## Что это

SPA — мульти-агентная AI-система для автоматизации анализа, управления рисками и оптимизации yield-стратегий в DeFi. Фокус — стабильное кредитование (USDC/USDT) на вайтлистовых протоколах. Система работает только в режиме **paper trading** до отдельного ADR на live-режим.
