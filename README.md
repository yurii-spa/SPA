...
Версия: v12.87 | Язык: Python 3 (stdlib-only runtime) | Статус: Paper Trading — реальный трек с honest anchor **2026-06-22** (**20/30** evidenced честных дней, GoLive 27/29, target ~2026-07-21)
